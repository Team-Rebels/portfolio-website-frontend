  ...
  const achievements = [
    {
      ...
      award: 'React Developer Certification',
    ...
    },
    {
      ...
      award: 'Top 10 Web Dev Hackathon',
      image: 'hackathon.jpg', // Placeholder for image URL or path
      institution: 'Hackathon Organizers',
      date: '2021-11-23',
    },
    {
      ...
      <div className="flex flex-cols-1 pt-20 gap-4">
        {achievements.map((achievement, index) => (
          <div key={index} className="bg-white rounded-xl shadow-md p-5 flex flex-col mb-4">
            ...
            <div className="text-gray-600">{achievement.award}</div>
            <div className="text-gray-600">{achievement.institution}</div>
